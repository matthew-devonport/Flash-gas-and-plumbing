                ...
                <div id='footer'>
                    ...
                    <a href="mailto:flashgasandplumbing@gmail.com"><img src="./img/email.png" alt="Emaillogo" className="emailLogo"></img></a>
                       ...
                       <h1 className="socialmedia">SOCIAL MEDIA</h1>
                            <li><Link><img src="./img/facebook.png" alt="Facebook logo" className="footerLogo facebook"></img> </Link></li>
                            <li><Link><img src="./img/instagram.png" alt="Instagram logo" className="footerLogo instagram"></img> </Link></li>
                        </ul>
